...
public class SemesterRecord extends UpdatableRecordImpl<SemesterRecord> implements Record3<String, String, Integer> {
     ...
     */
    @Override
    public SemesterRecord value1(String value) {
        setUuid(value);
        return this;
    }
     ...
     */
    @Override
    public SemesterRecord values(String value1, String value2, Integer value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public SemesterRecord(String uuid, String term, Integer year) {
        super(Semester.SEMESTER);
